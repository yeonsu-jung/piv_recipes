...
def get_left_right_velocity_map_series(self,s):
    ...
    ul_path = os.path.join(self.results_path,left_path,'u_series_%s.txt'%s)
    vl_path = os.path.join(self.results_path,left_path,'v_series_%s.txt'%s)

    ur_path = os.path.join(self.results_path,right_path,'u_series_%s.txt'%s)
    vr_path = os.path.join(self.results_path,right_path,'v_series_%s.txt'%s)
