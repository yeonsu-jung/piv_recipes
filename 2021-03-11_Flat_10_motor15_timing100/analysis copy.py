...
# %%
d = np.loadtxt('/Users/yeonsu/Dropbox (Harvard University)/Riblet/data/piv-results/2021-03-11/Flat_10 (black)_motor15_2/Flat_10 (black)_motor15.00_pos1_VOFFSET0_ag1_dg1_laser5_[03-11]/x_full.txt')
d.shape
...
# %%
# plt.plot(x_top,np.mean(u_top,axis=0))
plt.plot(x_top,v_top_filtered)
# plt.plot(x_bottom,u_bottom_filtered)
plt.plot(x_top,v_bottom_filtered)
...
# %%
Drag = momentum_deficit_filtered + pressure_difference
print(Drag)
# %%
