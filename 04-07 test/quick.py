...
piv_cond = {
    ...
    "transpose": False, "crop": [0,0,770,0],    
...
# %%
path_to_study = 'vid_2021-04-07_11-24-13'
d = pi.quick_piv({'path': path_to_study},index_a=31,index_b=32)

# %%

path_to_study = 'vid_2021-04-07_11-39-27'
d = pi.quick_piv({'path': path_to_study},index_a=30,index_b=31)

# %%
img_a,img_b = pi.read_two_images({'path': 'vid_2021-04-07_11-39-27'},index_a=20,index_b=21)
