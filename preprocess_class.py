...
class preprocess_class:
    def __init__(self,img): # img or img path

        self.bw = img[:,:] > 100
        self.labels = measure.label(self.bw)        

        w1, w2 = self.get_wall_pixels()
        idx1, w1_new = self.locate_lines2(w1)
        idx2, w2_new = self.locate_lines2(w2)
        
        w1_pos = min([np.min(idx1[1]), np.min(idx2[1])])
        w2_pos = max([np.min(idx1[1]), np.min(idx2[1])])

        return w1_pos, w2_pos    
...
# # %%
# path_a='C:/Users/yj/Dropbox (Harvard University)/Riblet/data/piv-data/2021-04-06/Flat_10 (black)_motor25_particle4_hori1280_laser1-4_nd0p7'
# path_a = path_a.replace('C:/Users/yj/','/Users/yeonsu/')
# path_b='C:/Users/yj/Dropbox (Harvard University)/Riblet/data/piv-data/2021-04-06/Flat_10 (black)_motor25_particle4_hori1280_laser1-4_nd0p7'
# path_b = path_a.replace('C:/Users/yj/','/Users/yeonsu/')
