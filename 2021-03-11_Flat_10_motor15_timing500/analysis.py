...
# %%
momentum_deficit3 = momentum_left2 + momentum_right2 - (flowrate_left2+flowrate_right2)*np.mean(u_bottom*0.001)
...
pressure_difference = 0.5 * rho * (U_inf_last**2 - U_inf_first**2)*0.048 * 0.015
print(0.5 * rho * (U_inf_last**2 - U_inf_first**2)*0.048 * 0.015)
# %%
